                    ...
                    <div className="card-body">
                        <div className="d-flex justify-content-between">
                            ...
                            <div className="d-flex mb-3">
                                <button type="button" onClick={() => edit()} className="p-2 btn" data-bs-toggle="modal" data-bs-target="#editModal">
                                    <i className="fa fa-pen mx-2 fs-4"></i>
                                </button>


                                <button type="button" className="p-2 btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
